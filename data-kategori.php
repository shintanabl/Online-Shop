    ...
    <body>
       ...
       <div class="section">
           <div class="container">
               <h3>Data Kategori</h3>
               <div class="box">
                   <p><a href="tambah-kategori">Tambah Data</a></p>
                   <table border="1" cellspacing="0" class="table">
                       ...
                       <tbody>
                           ...
                           <tr>
                               ...
                               <td>
                                   <a href="edit-kategori?id=<?php echo $row['id_category']?>">Edit</a> || <a href="hapus-kategori?idk=<?php echo $row['id_category'] ?>" onclick="return confirm('Yakin Ingin Hapus ?')">Hapus</a>
                               </td>
                           </tr>
                           <?php }}else{ ?>
                            <tr>
